...
export const SampleBagData: IProductCard[] = [
  {
    ...
    description:
      'A sleek and elegant black bag perfect for both casual and formal occasions.',
    quantity: 5,
    subImage: [
  ...
  },
  {
    ...
    description:
      'A luxurious and timeless design that adds sophistication to any outfit.',
    quantity: 3,
    subImage: [
  ...
  },
  {
    ...
    description:
      'Exquisite craftsmanship and high-end materials make this bag a true investment piece.',
    quantity: 2,
    subImage: [
  ...
  },
  {
    ...
    description:
      'An iconic piece that epitomizes luxury and timeless fashion, perfect for any occasion.',
    quantity: 1,
    subImage: [
  ...
  // Shoes
  {
    ...
    description:
      'A high-performance basketball shoe designed for comfort and agility on the court.',
    quantity: 4,
    subImage: [
      'https://grandeurstore.ph/cdn/shop/files/A1_c9b3bdcb-2bb0-4e11-a552-88248c81d2d4.png?v=1718265779&width=713', // from Prada Luxury Bag
      'https://rustans.com/cdn/shop/files/3329697_3.jpg?v=1732849397&width=1000', // from Lacoste White Dial
  ...
  },
  {
    ...
    description:
      'A stylish and durable sneaker, ideal for both performance and streetwear fashion.',
    quantity: 3,
    subImage: [
      'https://cdn-images.farfetch-contents.com/13/20/16/04/13201604_54422838_1000.jpg', // from CK Black
      'https://is4.revolveassets.com/images/p4/n/uv/MARJ-WY505_V1.jpg', // from Louise Vitton Bag
  ...
  },
  {
    ...
    description:
      'Sleek and supportive, this sneaker offers comfort and traction for your active lifestyle.',
    quantity: 2,
    subImage: [
      'https://baginning.com/media/catalog/product/cache/79b7de24d0c40c829bb951f51913e3c1/w/h/white_leather_top_handle_bag_3_.jpg', // from Chanel Classic
      'https://m.media-amazon.com/images/I/71vz71m5usL._AC_SL1500_.jpg', // from Nike KD
  ...
  },
  {
    ...
    description:
      'A legendary sneaker that blends retro style with modern performance features.',
    quantity: 3,
    subImage: [
      'https://image.made-in-china.com/155f0j00PbUkJWirbQcs/Nine-West-Calandra-Mini-Flap-Crossbody-Woman-Tote-Bag-Fashion-Lady-Handbags.webp', // from Modern Fit
      'https://rustans.com/cdn/shop/files/3329697_3.jpg?v=1732849397&width=1000', // from Lacoste White Dial
  ...
  // Watches
  {
    ...
    description:
      'A clean and minimalist design, perfect for everyday wear with a touch of elegance.',
    quantity: 5,
    subImage: [
  ...
  },
  {
    ...
    description:
      'A sporty and vibrant watch with a modern design for the bold and adventurous.',
    quantity: 3,
    subImage: [
  ...
  },
  {
    ...
    image:
      'https://5.imimg.com/data5/FV/GM/MY-2/stylish-ladies-bag-1000x1000.jpg',
    description:
      'A luxury dive watch with outstanding precision and timeless style.',
    quantity: 2,
    subImage: [
  ...
  },
  {
    ...
    image: 'https://is4.revolveassets.com/images/p4/n/uv/MARJ-WY505_V1.jpg',
    description:
      'A stylish dive watch with advanced water resistance and a sporty aesthetic.',
    quantity: 3,
    subImage: [
      'https://rustans.com/cdn/shop/files/3329697_3.jpg?v=1732849397&width=1000', // Subimage from another product
      'https://5.imimg.com/data5/FV/GM/MY-2/stylish-ladies-bag-1000x1000.jpg', // Subimage from another product
  ...
  // Clothes
  {
    ...
    description:
      'A versatile and comfortable performance piece, perfect for active lifestyles.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'A contemporary fit designed to flatter and offer a modern, sleek silhouette.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'Built for comfort and style, this sports edition shirt supports performance in any activity.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'A practical and rugged design, combining utility with modern fashion trends.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  // Jewelry
  {
    ...
    image:
      'https://image.made-in-china.com/155f0j00PbUkJWirbQcs/Nine-West-Calandra-Mini-Flap-Crossbody-Woman-Tote-Bag-Fashion-Lady-Handbags.webp',
    description:
      'A stunning 18k gold necklace that exudes luxury and timeless elegance.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'A sparkling pendant that adds a touch of glamour to any outfit.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'A unique and modern jewelry piece, perfect for athletes or fashion-forward individuals.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
  ...
  },
  {
    ...
    description:
      'An exclusive Jordan 10 necklace that showcases a fusion of luxury and sporty flair.',
    quantity: 1,
    subImage: [
      'https://is4.revolveassets.com/images/p4/n/uv/FNEF-WY3305_V1.jpg', // from Swatch PON-Wave
      'https://m.media-amazon.com/images/I/71aJR2pwB+L._AC_SL1500_.jpg', // from Jordan 10
